...
public class TimeTableListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		request.setAttribute("timeTableList", list3);
...
//		bean.setId(DataUtility.getLong(request.getParameter("id")));
		...
		System.out.println(bean.getSemester()+"   l   "+ request.getParameter("semester"));
		// bean.setSubjectName(DataUtility.getString(request.getParameter("slist")));
		bean.setExamDate(DataUtility.getDate(request.getParameter("tlist")));
