	...
	<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" method="post">
		...
		<center>
			...
			<%
				...
				List semester = (List) request.getAttribute("timeTableList");
			%>
			<%
				...
				<tr>
					<td align="center"><label>Course Name :</label> <%=HTMLUtility.getList("clist", String.valueOf(bean.getCourseId()), cList)%>
						...
						<label>Semester</label><%
							...
							map1.put("7", "7");
							map1.put("8", "8");
							 String htmlList1 = HTMLUtility.getList("semester", bean.getExamTime(), map1);
							%> <%=htmlList1%> 
						<%-- <%=HTMLUtility.getList("semester", String.valueOf(bean.getSemester()), map1)%> --%>
