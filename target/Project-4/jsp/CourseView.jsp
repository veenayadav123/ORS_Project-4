			...
			<table>
				<tr>
					...
					<td><input type="text" name="name"
						placeholder="Enter Course Name" size="24"
				...
				<tr>
					<th align="left">Duration<span style="color: red" 
						value="<%=DataUtility.getStringData(bean.getDuration())%>">*</span></th>
					<td>
						<%
				...
				<tr>
					...
					<td><input type="text" name="description"
						placeholder="Enter Description" size="24"
